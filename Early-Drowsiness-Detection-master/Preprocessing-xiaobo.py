...
def gen(folder_list,window_size,stride,path1):
    for ID, folder in enumerate(folder_list):
        ...
        for txt_file in files_per_person:
            if txt_file == 'xiaobo_2_w100_o40_alert.txt':
            ...
            if txt_file == 'xiaobo_2_w100_o40_semisleepy.txt':
            ...
            if txt_file == 'xiaobo_2_w100_o40_sleepy.txt':
                blinksTXT = path1 + '/' + folder + '/' + txt_file
                Freq = np.loadtxt(blinksTXT, usecols=0)
                Amp = np.loadtxt(blinksTXT, usecols=1)
                Dur = np.loadtxt(blinksTXT, usecols=2)
            ...
            for txt_file in files_per_person:
                ...
                if txt_file == 'xiaobo_2_w100_o40_sleepy.txt':
                    ...
                    normalized_blinks = normalize_blinks(blink_num, Freq, u_Freq, sigma_Freq, Amp, u_Amp, sigma_Amp,
                                                         Dur,u_Dur, sigma_Dur, Vel, u_Vel, sigma_Vel)
                    # print(
...
path1='xiaobow100o40'
window_size=30
#change window_size to 60
stride=2
Training='xiaobow100o40npy/xiaobo_30_Fold5.npy'
Testing='xiaobow100o40npy/xiaoboTest_30_Fold5.npy'
...
np.save(open('xiaobow100o40npy/xiaoboLabels_30_Fold5.npy', 'wb'),labels)
np.save(open(Testing, 'wb'),blinksTest)
np.save(open('xiaobow100o40npy/xiaoboLabelsTest_30_Fold5.npy', 'wb'), labelTest)

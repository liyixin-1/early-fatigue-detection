...
def gen(folder_list,window_size,stride,path1):
    for ID, folder in enumerate(folder_list):
        ...
        for txt_file in files_per_person:
            if txt_file == 'xiaobo_1_w100_o60_alert.txt':
            ...
            if txt_file == 'xiaobo_1_w100_o60_semisleepy.txt':
            ...
            if txt_file == 'xiaobo_1_w100_o60_sleepy.txt':
                blinksTXT = path1 + '/' + folder + '/' + txt_file
                Freq = np.loadtxt(blinksTXT, usecols=0)
                Amp = np.loadtxt(blinksTXT, usecols=1)
                Dur = np.loadtxt(blinksTXT, usecols=2)
...
#path1 is the address to the folder of all subjects, each subject has three txt files for alert, semisleepy and sleepy levels
path1='xbgazew100o60wei1'
window_size=30
stride=2
for i in range(1,6):
    Training='xbgazew100o60wei1npy/xiaobo_30_Fold%d.npy'%i
    Testing='xbgazew100o60wei1npy/xiaoboTest_30_Fold%d.npy'%i
    label='xbgazew100o60wei1npy/Labels_30_Fold%d.npy'%i
    labeltest='xbgazew100o60wei1npy/LabelsTest_30_Fold%d.npy'%i
